...
<template>
  <section
    id="projects"
    class="projects section-pad"
    aria-labelledby="projects-title"
  >
    <div class="section-header" data-reveal>
      <div>
        <div class="section-kicker">
          {{ content.sections.projectsKicker }}
        </div>
    ...
    <div class="project-grid">
      <article
        ...
        data-project-card
      >
        <div class="project-art" :class="project.tone">
          <span>
            {{ project.number }}
          </span>
        ...
        <div class="project-body">
          ...
          <div class="project-bottom">
            ...
            <div class="project-links">
              <a
                v-if="project.source"
                :href="project.source ?? 'https://github.com/deepreshion'"
                target="_blank"
                :aria-label="`${project.title} ${content.projectLinks.github}`"
              >
                <Github :size="17" />
              </a>
              <a
