...
export const portfolioMessages = {
  en: {
    ...
    projects: [
      { number: '01', title: 'Code-first CMS', description: 'A Symfony-bundle CMS with metadata-driven admin sections, dynamic form rendering and Vite-based frontend delivery. New admin sections moved from days of custom frontend work to hours.', stack: ['Vue 3', 'TypeScript', 'Vite', 'Symfony'], tone: 'lime', image: '/images/projects/cms.jpg'},
      { number: '02', title: 'OptiFit Workout Tracker', description: 'A self-built workout tracking app for strength training, cardio and activity logs, prepared for Telegram Mini Apps and a Capacitor mobile version.', stack: ['Vue 3', 'Quasar', 'Pinia', 'Telegram Mini Apps'], tone: 'silver', image: '/images/projects/optifit.jpg', source: 'https://github.com/deepreshion/opti-fit', url: 'https://deepreshion.github.io/opti-fit'  },
  ...
  ru: {
    ...
    projects: [
      { number: '01', title: 'Code-first CMS', description: 'CMS в виде Symfony-бандла с админ-разделами на основе метаданных, динамическим рендерингом форм и фронтендом на Vite. Создание новых админ-разделов ускорилось с дней кастомной разработки до часов.', stack: ['Vue 3', 'TypeScript', 'Vite', 'Symfony'], tone: 'lime', image: '/images/projects/cms.jpg' },
      { number: '02', title: 'OptiFit трекер физической активности', description: 'Собственное приложение для учета силовых тренировок, кардио и активности, подготовленное для Telegram Mini Apps и мобильной версии на Capacitor.', stack: ['Vue 3', 'Quasar', 'Pinia', 'Telegram Mini Apps'], tone: 'silver', image: '/images/projects/optifit.jpg', source: 'https://github.com/deepreshion/opti-fit', url: 'https://deepreshion.github.io/opti-fit'  },
