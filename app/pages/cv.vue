      ...
      <div class="hero">
        <div>
          <div class="photo-card">
            <img
              class="photo"
              :src="`${baseURL}images/cv-photo.png`"
              :alt="cv.portraitAlt"
            />
          </div>
          <div class="contact">
            <div>
              <b> Email </b>
              <a href="mailto:deepreshion@gmail.com"> deepreshion@gmail.com </a>
            </div>
            <div>
              <b> GitHub </b>
              <a href="https://github.com/deepreshion">
                github.com/deepreshion
              </a>
            </div>
            <div>
              <b> LinkedIn </b>
              <a href="https://linkedin.com/in/deepreshion">
                linkedin.com/in/deepreshion
              </a>
            </div>
            <div>
              <b>
...
html:has(.cv-template),
body:has(.cv-template) {
  margin: 0;
  background: #101010;
  color: var(--text);
...
.job:before {
  ...
  background: var(--accent);
  border-radius: 50%;
  box-shadow: 0 0 0 2mm var(--surface);
}
.job-head {
  display: flex;
...
.cv-template .timeline ul {
  list-style: disc;
  margin: 3mm 0 0;
  padding-left: 4.5mm;
  display: block;
}
.cv-template .timeline li {
  display: list-item;
  align-items: initial;
  gap: 0;
  color: #d8d8d8;
